...
;;; Ver. 18.52   created  by S. Tomura 88-Mar-16
;;; Ver. 18.51a  modified by S. Tomura 88-Jul-19
;;;              convertion to babyl format fixed.
;;;              rmail-last-file, rmail-last-rmail-file are set their defaults.
...
;;; patch by S. Tomura 88-Jul-19
(set-default 'rmail-last-file (expand-file-name "~/mbox"))
(set-default 'rmail-last-rmail-file (expand-file-name "~/XMAIL"))
;;; end of patch
