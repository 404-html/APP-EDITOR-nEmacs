;;; Basic editing Commands for Egg on Nemacs
  ...
  (let ((fill-point
	 (let ((opoint (point)))
	   (save-excursion
	     ...
	     ;;; patched by S. Tomura 88-Jun-16, 89-Oct-21
		 ...
		 nil
		   ...
		   (forward-char 1))
	       (if (or (bobp) (bolp)) 
		   (if (re-search-forward "[ \t]\\|\\z" opoint t) ;;; 88-Jun-11 by S.Tomura, 89-Nov-17
		       (backward-char 1)))
	       (skip-chars-backward " \t"))
	     (kinsoku-shori)
	     ;;; end of patch
