...
#ifdef POINTMARKER
extern int insert (), insert_before_markers (), insert_after_markers ();
#endif
/* end of patch */
...
#ifdef POINTMARKER
{
  insert_with_specified_function (insert, nargs, args);
  return Qnil;
}

insert_with_specified_function (func, nargs, args)
     int (*func)(), nargs;
     register Lisp_Object *args;
#endif
/* end of patch */
...
#else
{
  insert_with_specified_function (insert_before_markers, nargs, args);
  return Qnil;
}
#endif
/* end of patch */
...
the insertion point get relocated to point before the newly inserted text.")
  (nargs, args)
     ...
     register Lisp_Object *args;
{
  insert_with_specified_function (insert_after_markers, nargs, args);
  return Qnil;
}
#endif
/* end of patch */
