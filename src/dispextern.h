...
struct matrix
{
  ...
  char *enable;
#ifdef NEMACS
  char *kanji_flag;		/* 1 means the kanji_flag of the
				   buffer of this line is T */
#endif
#ifdef ATTRIBUTE
  char *total_attribute;
/* patch for attribute by K.Handa  89.11.21 */
  char **attribute; /* attribute of each character */
#endif
};
...
#define ATTR_INVERSE	2
extern char *attribute_p;	/* oops! */
#endif
/* end of patch */
