...
# is running on both sides of the pipe.
	...
	$(INSTALL) -s -c etc/emacsclient ${BINDIR}/emacsclient
	$(INSTALL) -s -c etc/etags ${BINDIR}/etags
	$(INSTALL) -s -c etc/ctags ${BINDIR}/ctags
	$(INSTALL) -s -c -m 1755 src/xemacs ${BINDIR}/xemacs
